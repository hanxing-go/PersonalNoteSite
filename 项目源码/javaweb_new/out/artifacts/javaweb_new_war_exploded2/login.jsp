      ...
      <div class="container right-panel-active"
        ...
        <div class="container__form container--signup">
          <form action="#" class="form" method="post" id="registerform">
            ...
            <input type="text" placeholder="User" class="input" id="register_username" name="resgister_username"/>
            <input type="email" placeholder="Email" class="input" id="register_email" name="resgister_email"/>
            <input type="password" placeholder="Password" class="input" id="register_password" name="resgister_password"/>
        ...
        <div class="container__form container--signin">
          <form action=UserServlet class="form" method="get" id="loginform">
            <h2 class="form__title">登录</h2>
            <input type="hidden" name="actionName" value="login" />
            <input type="email" placeholder="Email" class="input" id="login_email" name="login_username"/>
